...
Want to make your Ruby Service the primary service so that it is served to your project's root url (`<projectID>.wedeploy.io`)? Perfect, that is extremely easy to do. Go to the settings tab of your project's console and select _ruby_ as your _Home Service_.
