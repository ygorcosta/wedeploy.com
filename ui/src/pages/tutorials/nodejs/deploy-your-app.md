...
Open up your terminal and go to the `tutorial-nodejs` folder. Then, add a git remote by running:
...
Give it a few moments and then go to `nodejs-<projectID>.wedeploy.sh` to see what you deployed! Pretty cool, right?
