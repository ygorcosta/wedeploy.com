...
function $render(opt_data, opt_ignored, opt_ijData) {
  opt_data = opt_data || {};
  var param1220 = function() {
    ie_open('h1');
      itext('Ruby');
    ie_close('h1');
    ie_open('h6');
      itext('Launch a Ruby application in few steps.');
    ie_close('h6');
    ...
    ie_open('article', null, null,
      ...
      ie_open('ol');
        ie_open('li');
          ie_open('p');
            ie_open('a', null, null,
                'href', 'https://github.com/wedeploy/boilerplate-ruby/fork');
  ...
  $templateAlias1(soy.$$assignDefaults({content: param1220}, opt_data), null, opt_ijData);
}
...
class docsOtherRubyHtml extends Component {}
Soy.register(docsOtherRubyHtml, templates);
export { docsOtherRubyHtml, templates };
