...
function $render(opt_data, opt_ignored, opt_ijData) {
  opt_data = opt_data || {};
  var param1175 = function() {
    ie_open('h1');
      itext('Node.js');
    ie_close('h1');
    ie_open('h6');
      itext('Launch a Node.js application in few steps.');
    ie_close('h6');
    ...
    ie_open('div', null, null,
      ...
      itext('or read the ');
      ie_open('a', null, null,
          'href', 'https://github.com/wedeploy/boilerplate-nodejs/',
          'target', '_blank');
        itext('source code');
      ie_close('a');
      itext('.');
    ...
    ie_open('article', null, null,
      ...
      ie_open('ol');
        ie_open('li');
          ie_open('p');
            ie_open('a', null, null,
                'href', 'https://github.com/wedeploy/boilerplate-nodejs/fork');
...
class docsOtherNodejsHtml extends Component {}
Soy.register(docsOtherNodejsHtml, templates);
export { docsOtherNodejsHtml, templates };
