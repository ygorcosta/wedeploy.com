...
function $render(opt_data, opt_ignored, opt_ijData) {
  ...
  var param1090 = function() {
    ...
    ie_close('h1');
    ie_open('h6');
      itext('Launch a Java 8 application in few steps.');
    ie_close('h6');
    ...
    ie_open('article', null, null,
      ...
      ie_open('ol');
        ie_open('li');
          ie_open('p');
            ie_open('a', null, null,
                'href', 'https://github.com/wedeploy/boilerplate-java/fork');
...
class docsOtherJavaHtml extends Component {}
Soy.register(docsOtherJavaHtml, templates);
export { docsOtherJavaHtml, templates };
