...
goog.module('eSQAT.incrementaldom');
...
function $render(opt_data, opt_ignored, opt_ijData) {
  var param1724 = function() {
    ...
    ie_open('article', null, null,
      ...
      ie_close('h2');
      ie_open('p');
        itext('Our Hosting service allows you to deliver HTML, CSS, JavaScript, or any other static files using powerful static hosting. It\'s super fast and will save you a lot of time.');
      ie_close('p');
    ie_close('article');
    ie_open('article', null, null,
        'id', '2');
      ...
      ie_close('h2');
      ie_open('p');
        itext('Want to see the process of deploying WeDeploy Hosting step by step?');
      ie_close('p');
...
if (goog.DEBUG) {
  $render.soyTemplateName = 'eSQAT.render';
}
