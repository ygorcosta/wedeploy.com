...
goog.module('BODSH.incrementaldom');
...
function $render(opt_data, opt_ignored, opt_ijData) {
  var param3547 = function() {
    ...
    ie_open('p');
      ...
      ie_open('code');
        itext('liferay-<projectID>.wedeploy.sh');
      ie_close('code');
      itext(' to see what you deployed! Pretty cool, right?');
    ie_close('p');
    ie_open('figure');
      ie_open('img', null, null,
          'src', '/images/tutorials/liferay-live.png',
          'alt', 'Liferay Live!');
      ie_close('img');
    ie_close('figure');
    ie_open('aside');
  ...
  $templateAlias1(soy.$$assignDefaults({content: param3547}, opt_data), null, opt_ijData);
}
exports.render = $render;
if (goog.DEBUG) {
  $render.soyTemplateName = 'BODSH.render';
}
