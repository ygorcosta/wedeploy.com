...
goog.module('fnXOW.incrementaldom');
...
function $render(opt_data, opt_ignored, opt_ijData) {
  var param3733 = function() {
    ...
    ie_open('p');
      ...
      ie_open('code');
        itext('tutorial-email-web/hosting/main.js');
      ie_close('code');
    ...
    ie_open('ol');
      ...
      ie_close('li');
      ie_open('li');
        itext('Paste it into the ');
        ie_open('code');
          itext('.auth(\'yourMasterToken\')');
        ie_close('code');
        itext(' element in the code above on ');
        ie_open('code');
          itext('main.js');
        ie_close('code');
      ie_close('li');
  ...
  $templateAlias1(soy.$$assignDefaults({content: param3733}, opt_data), null, opt_ijData);
}
exports.render = $render;
if (goog.DEBUG) {
  $render.soyTemplateName = 'fnXOW.render';
}
