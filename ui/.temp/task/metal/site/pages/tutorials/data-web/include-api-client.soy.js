...
goog.module('WjWwf.incrementaldom');
...
function $render(opt_data, opt_ignored, opt_ijData) {
  var param2852 = function() {
    ie_open('h4');
      itext('Include API Client');
    ie_close('h4');
    ie_open('p');
      itext('Before we can make any requests to save or fetch data, we must connect the WeDeploy API Client.');
    ie_close('p');
    ie_open('p');
      itext('To do this, go to ');
      ie_open('code');
        itext('tutorial-data-web/hosting/');
      ie_close('code');
  ...
  $templateAlias1(soy.$$assignDefaults({content: param2852}, opt_data), null, opt_ijData);
}
exports.render = $render;
if (goog.DEBUG) {
  $render.soyTemplateName = 'WjWwf.render';
}
