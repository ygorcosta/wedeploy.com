...
goog.module('ICEto.incrementaldom');
...
function $render(opt_data, opt_ignored, opt_ijData) {
  var param3914 = function() {
    ...
    ie_open('p');
      ...
      ie_open('code');
        itext('ruby-<projectID>.wedeploy.sh');
      ie_close('code');
  ...
  $templateAlias1(soy.$$assignDefaults({content: param3914}, opt_data), null, opt_ijData);
}
exports.render = $render;
if (goog.DEBUG) {
  $render.soyTemplateName = 'ICEto.render';
}
