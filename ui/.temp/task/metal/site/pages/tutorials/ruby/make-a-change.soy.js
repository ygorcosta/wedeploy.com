...
goog.module('qLKRj.incrementaldom');
...
function $render(opt_data, opt_ignored, opt_ijData) {
  var param3941 = function() {
    ...
    ie_open('aside');
      ...
      ie_close('h6');
      ie_open('p');
        itext('Want to make your Ruby Service the primary service so that it is served to your project\'s root url (');
        ie_open('code');
  ...
  $templateAlias1(soy.$$assignDefaults({content: param3941}, opt_data), null, opt_ijData);
}
exports.render = $render;
if (goog.DEBUG) {
  $render.soyTemplateName = 'qLKRj.render';
}
