...
goog.module('zKzkl.incrementaldom');
...
function $render(opt_data, opt_ignored, opt_ijData) {
    ...
    ie_open('aside');
      ...
      ie_open('p');
        ...
        ie_open('code');
          itext('wedeploy.json');
        ie_close('code');
        itext(', we will automatically choose a random service id for you. To choose the id of your hosting service yourself, add ');
        ie_open('code');
  ...
  $templateAlias1(soy.$$assignDefaults({content: param3325}, opt_data), null, opt_ijData);
}
exports.render = $render;
if (goog.DEBUG) {
  $render.soyTemplateName = 'zKzkl.render';
}
