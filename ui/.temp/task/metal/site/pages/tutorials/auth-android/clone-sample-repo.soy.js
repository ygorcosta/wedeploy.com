...
goog.module('bozJp.incrementaldom');
...
function $render(opt_data, opt_ignored, opt_ijData) {
  var param2036 = function() {
    ie_open('h4');
      itext('Clone Sample Repo');
    ie_close('h4');
    ie_open('p');
      itext('First, you\'ll clone a sample repo that contains the necessary files and directories for deploying an site with Auth and for creating an app that make use of these services.');
    ie_close('p');
    ie_open('p');
      itext('Run this command in your terminal:');
    ie_close('p');
    $templateAlias2({code: 'git clone https://github.com/wedeploy/tutorial-auth-android.git', mode: 'text'}, null, opt_ijData);
    ie_open('p');
...
if (goog.DEBUG) {
  $render.soyTemplateName = 'bozJp.render';
}
