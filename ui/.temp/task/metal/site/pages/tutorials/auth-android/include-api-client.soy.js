...
goog.module('eYmFc.incrementaldom');
...
function $render(opt_data, opt_ignored, opt_ijData) {
  var param2087 = function() {
    ...
    ie_open('p');
      ...
      ie_open('code');
        itext('tutorial-auth-android/app/tutorial-auth-android/app/build.gradle');
      ie_close('code');
    ...
    ie_open('p');
      itext('After doing this, you have to sync the project and then a few seconds later you will see that the project is built correctly.');
    ie_close('p');
  ...
  $templateAlias1(soy.$$assignDefaults({content: param2087}, opt_data), null, opt_ijData);
}
exports.render = $render;
if (goog.DEBUG) {
  $render.soyTemplateName = 'eYmFc.render';
}
