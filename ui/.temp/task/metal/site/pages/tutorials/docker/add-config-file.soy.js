...
goog.module('Vmgop.incrementaldom');
...
function $render(opt_data, opt_ignored, opt_ijData) {
  var param2907 = function() {
    ...
    ie_open('aside');
      ...
      ie_open('p');
        ...
        ie_open('a', null, null,
            'href', 'http://wedeploy.com/docs/docker/environment-variables.html',
            'target', '_blank');
          itext('Environment Variables for Docker');
        ie_close('a');
        itext('.');
      ie_close('p');
    ie_close('aside');
  ...
  $templateAlias1(soy.$$assignDefaults({content: param2907}, opt_data), null, opt_ijData);
}
exports.render = $render;
if (goog.DEBUG) {
  $render.soyTemplateName = 'Vmgop.render';
}
