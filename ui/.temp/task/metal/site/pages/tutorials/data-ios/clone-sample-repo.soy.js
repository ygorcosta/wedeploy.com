...
goog.module('AkVgi.incrementaldom');
...
function $render(opt_data, opt_ignored, opt_ijData) {
  var param2498 = function() {
    ...
    ie_close('p');
    $templateAlias2({code: 'git clone https://github.com/wedeploy/tutorial-data-ios.git', mode: 'text'}, null, opt_ijData);
    ie_open('p');
...
if (goog.DEBUG) {
  $render.soyTemplateName = 'AkVgi.render';
}
