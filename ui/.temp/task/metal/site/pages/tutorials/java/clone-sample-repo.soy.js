...
goog.module('tzBZb.incrementaldom');
...
function $render(opt_data, opt_ignored, opt_ijData) {
  var param3432 = function() {
    ...
    ie_close('p');
    $templateAlias2({code: 'git clone https://github.com/wedeploy/tutorial-java.git', mode: 'xml'}, null, opt_ijData);
    ie_open('p');
  ...
  $templateAlias1(soy.$$assignDefaults({content: param3432}, opt_data), null, opt_ijData);
}
exports.render = $render;
if (goog.DEBUG) {
  $render.soyTemplateName = 'tzBZb.render';
}
