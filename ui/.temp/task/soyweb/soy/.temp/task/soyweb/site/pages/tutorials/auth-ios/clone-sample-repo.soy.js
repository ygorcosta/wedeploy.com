...
if (typeof vGXRj == 'undefined') { var vGXRj = {}; }
 ...
 * @suppress {checkTypes}
 */
vGXRj.soyweb = function(opt_data, opt_ignored, opt_ijData) {
  return soydata.VERY_UNSAFE.ordainSanitizedHtml(base.render(soy.$$augmentMap(opt_data, {content: soydata.VERY_UNSAFE.$$ordainSanitizedHtmlForInternalBlocks('' + vGXRj.render(opt_data, null, opt_ijData))}), null, opt_ijData));
};
if (goog.DEBUG) {
  vGXRj.soyweb.soyTemplateName = 'vGXRj.soyweb';
}
