...
if (typeof SAJNr == 'undefined') { var SAJNr = {}; }
 ...
 * @suppress {checkTypes}
 */
SAJNr.soyweb = function(opt_data, opt_ignored, opt_ijData) {
  return soydata.VERY_UNSAFE.ordainSanitizedHtml(base.render(soy.$$augmentMap(opt_data, {content: soydata.VERY_UNSAFE.$$ordainSanitizedHtmlForInternalBlocks('' + SAJNr.render(opt_data, null, opt_ijData))}), null, opt_ijData));
};
if (goog.DEBUG) {
  SAJNr.soyweb.soyTemplateName = 'SAJNr.soyweb';
}
