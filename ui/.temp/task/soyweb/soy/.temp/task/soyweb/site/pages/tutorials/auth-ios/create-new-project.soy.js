...
/**
 * @fileoverview Templates in namespace zMYkI.
 */

if (typeof zMYkI == 'undefined') { var zMYkI = {}; }
 ...
 * @suppress {checkTypes}
 */
zMYkI.render = function(opt_data, opt_ignored, opt_ijData) {
...
if (goog.DEBUG) {
  zMYkI.render.soyTemplateName = 'zMYkI.render';
}
 ...
 * @suppress {checkTypes}
 */
zMYkI.soyweb = function(opt_data, opt_ignored, opt_ijData) {
  return soydata.VERY_UNSAFE.ordainSanitizedHtml(base.render(soy.$$augmentMap(opt_data, {content: soydata.VERY_UNSAFE.$$ordainSanitizedHtmlForInternalBlocks('' + zMYkI.render(opt_data, null, opt_ijData))}), null, opt_ijData));
};
if (goog.DEBUG) {
  zMYkI.soyweb.soyTemplateName = 'zMYkI.soyweb';
}
