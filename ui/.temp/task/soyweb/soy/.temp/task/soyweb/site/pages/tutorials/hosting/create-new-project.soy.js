...
/**
 * @fileoverview Templates in namespace lRTLC.
 */

if (typeof lRTLC == 'undefined') { var lRTLC = {}; }
 ...
 * @suppress {checkTypes}
 */
lRTLC.render = function(opt_data, opt_ignored, opt_ijData) {
...
if (goog.DEBUG) {
  lRTLC.render.soyTemplateName = 'lRTLC.render';
}
 ...
 * @suppress {checkTypes}
 */
lRTLC.soyweb = function(opt_data, opt_ignored, opt_ijData) {
  return soydata.VERY_UNSAFE.ordainSanitizedHtml(base.render(soy.$$augmentMap(opt_data, {content: soydata.VERY_UNSAFE.$$ordainSanitizedHtmlForInternalBlocks('' + lRTLC.render(opt_data, null, opt_ijData))}), null, opt_ijData));
};
if (goog.DEBUG) {
  lRTLC.soyweb.soyTemplateName = 'lRTLC.soyweb';
}
