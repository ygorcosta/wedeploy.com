...
/**
 * @fileoverview Templates in namespace dUOJE.
 */

if (typeof dUOJE == 'undefined') { var dUOJE = {}; }
 ...
 * @suppress {checkTypes}
 */
dUOJE.render = function(opt_data, opt_ignored, opt_ijData) {
...
if (goog.DEBUG) {
  dUOJE.render.soyTemplateName = 'dUOJE.render';
}
 ...
 * @suppress {checkTypes}
 */
dUOJE.soyweb = function(opt_data, opt_ignored, opt_ijData) {
  return soydata.VERY_UNSAFE.ordainSanitizedHtml(base.render(soy.$$augmentMap(opt_data, {content: soydata.VERY_UNSAFE.$$ordainSanitizedHtmlForInternalBlocks('' + dUOJE.render(opt_data, null, opt_ijData))}), null, opt_ijData));
};
if (goog.DEBUG) {
  dUOJE.soyweb.soyTemplateName = 'dUOJE.soyweb';
}
