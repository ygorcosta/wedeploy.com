...
if (typeof sPprg == 'undefined') { var sPprg = {}; }
 ...
 * @suppress {checkTypes}
 */
sPprg.render = function(opt_data, opt_ignored, opt_ijData) {
...
if (goog.DEBUG) {
  sPprg.render.soyTemplateName = 'sPprg.render';
}
 ...
 * @suppress {checkTypes}
 */
sPprg.soyweb = function(opt_data, opt_ignored, opt_ijData) {
  return soydata.VERY_UNSAFE.ordainSanitizedHtml(base.render(soy.$$augmentMap(opt_data, {content: soydata.VERY_UNSAFE.$$ordainSanitizedHtmlForInternalBlocks('' + sPprg.render(opt_data, null, opt_ijData))}), null, opt_ijData));
};
if (goog.DEBUG) {
  sPprg.soyweb.soyTemplateName = 'sPprg.soyweb';
}
