...
/**
 * @fileoverview Templates in namespace NFOHM.
 */

if (typeof NFOHM == 'undefined') { var NFOHM = {}; }
 ...
 * @suppress {checkTypes}
 */
NFOHM.soyweb = function(opt_data, opt_ignored, opt_ijData) {
  return soydata.VERY_UNSAFE.ordainSanitizedHtml(base.render(soy.$$augmentMap(opt_data, {content: soydata.VERY_UNSAFE.$$ordainSanitizedHtmlForInternalBlocks('' + NFOHM.render(opt_data, null, opt_ijData))}), null, opt_ijData));
};
if (goog.DEBUG) {
  NFOHM.soyweb.soyTemplateName = 'NFOHM.soyweb';
}
