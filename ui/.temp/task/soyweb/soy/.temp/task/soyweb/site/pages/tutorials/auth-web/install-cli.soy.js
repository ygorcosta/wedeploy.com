...
/**
 * @fileoverview Templates in namespace RhtLd.
 */

if (typeof RhtLd == 'undefined') { var RhtLd = {}; }
 ...
 * @suppress {checkTypes}
 */
RhtLd.render = function(opt_data, opt_ignored, opt_ijData) {
...
if (goog.DEBUG) {
  RhtLd.render.soyTemplateName = 'RhtLd.render';
}
 ...
 * @suppress {checkTypes}
 */
RhtLd.soyweb = function(opt_data, opt_ignored, opt_ijData) {
  return soydata.VERY_UNSAFE.ordainSanitizedHtml(base.render(soy.$$augmentMap(opt_data, {content: soydata.VERY_UNSAFE.$$ordainSanitizedHtmlForInternalBlocks('' + RhtLd.render(opt_data, null, opt_ijData))}), null, opt_ijData));
};
if (goog.DEBUG) {
  RhtLd.soyweb.soyTemplateName = 'RhtLd.soyweb';
}
