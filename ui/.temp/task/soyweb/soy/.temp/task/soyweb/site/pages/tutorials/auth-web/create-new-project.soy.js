...
/**
 * @fileoverview Templates in namespace LeKxm.
 */

if (typeof LeKxm == 'undefined') { var LeKxm = {}; }
 ...
 * @suppress {checkTypes}
 */
LeKxm.render = function(opt_data, opt_ignored, opt_ijData) {
...
if (goog.DEBUG) {
  LeKxm.render.soyTemplateName = 'LeKxm.render';
}
 ...
 * @suppress {checkTypes}
 */
LeKxm.soyweb = function(opt_data, opt_ignored, opt_ijData) {
  return soydata.VERY_UNSAFE.ordainSanitizedHtml(base.render(soy.$$augmentMap(opt_data, {content: soydata.VERY_UNSAFE.$$ordainSanitizedHtmlForInternalBlocks('' + LeKxm.render(opt_data, null, opt_ijData))}), null, opt_ijData));
};
if (goog.DEBUG) {
  LeKxm.soyweb.soyTemplateName = 'LeKxm.soyweb';
}
