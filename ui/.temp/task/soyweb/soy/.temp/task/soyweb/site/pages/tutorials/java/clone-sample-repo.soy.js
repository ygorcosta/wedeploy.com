...
/**
 * @fileoverview Templates in namespace tzBZb.
 */

if (typeof tzBZb == 'undefined') { var tzBZb = {}; }
 ...
 * @suppress {checkTypes}
 */
tzBZb.soyweb = function(opt_data, opt_ignored, opt_ijData) {
  return soydata.VERY_UNSAFE.ordainSanitizedHtml(base.render(soy.$$augmentMap(opt_data, {content: soydata.VERY_UNSAFE.$$ordainSanitizedHtmlForInternalBlocks('' + tzBZb.render(opt_data, null, opt_ijData))}), null, opt_ijData));
};
if (goog.DEBUG) {
  tzBZb.soyweb.soyTemplateName = 'tzBZb.soyweb';
}
