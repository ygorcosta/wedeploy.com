...
/**
 * @fileoverview Templates in namespace NcSGH.
 */

if (typeof NcSGH == 'undefined') { var NcSGH = {}; }
 ...
 * @suppress {checkTypes}
 */
NcSGH.soyweb = function(opt_data, opt_ignored, opt_ijData) {
  return soydata.VERY_UNSAFE.ordainSanitizedHtml(base.render(soy.$$augmentMap(opt_data, {content: soydata.VERY_UNSAFE.$$ordainSanitizedHtmlForInternalBlocks('' + NcSGH.render(opt_data, null, opt_ijData))}), null, opt_ijData));
};
if (goog.DEBUG) {
  NcSGH.soyweb.soyTemplateName = 'NcSGH.soyweb';
}
