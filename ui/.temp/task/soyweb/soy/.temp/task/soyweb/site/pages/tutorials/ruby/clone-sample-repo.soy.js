...
if (typeof KTEFj == 'undefined') { var KTEFj = {}; }
 ...
 * @suppress {checkTypes}
 */
KTEFj.soyweb = function(opt_data, opt_ignored, opt_ijData) {
  return soydata.VERY_UNSAFE.ordainSanitizedHtml(base.render(soy.$$augmentMap(opt_data, {content: soydata.VERY_UNSAFE.$$ordainSanitizedHtmlForInternalBlocks('' + KTEFj.render(opt_data, null, opt_ijData))}), null, opt_ijData));
};
if (goog.DEBUG) {
  KTEFj.soyweb.soyTemplateName = 'KTEFj.soyweb';
}
