...
/**
 * @fileoverview Templates in namespace wunsz.
 */

if (typeof wunsz == 'undefined') { var wunsz = {}; }
 ...
 * @suppress {checkTypes}
 */
wunsz.render = function(opt_data, opt_ignored, opt_ijData) {
...
if (goog.DEBUG) {
  wunsz.render.soyTemplateName = 'wunsz.render';
}
 ...
 * @suppress {checkTypes}
 */
wunsz.soyweb = function(opt_data, opt_ignored, opt_ijData) {
  return soydata.VERY_UNSAFE.ordainSanitizedHtml(base.render(soy.$$augmentMap(opt_data, {content: soydata.VERY_UNSAFE.$$ordainSanitizedHtmlForInternalBlocks('' + wunsz.render(opt_data, null, opt_ijData))}), null, opt_ijData));
};
if (goog.DEBUG) {
  wunsz.soyweb.soyTemplateName = 'wunsz.soyweb';
}
