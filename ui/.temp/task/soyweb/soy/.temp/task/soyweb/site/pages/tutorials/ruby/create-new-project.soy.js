...
/**
 * @fileoverview Templates in namespace dtqcU.
 */

if (typeof dtqcU == 'undefined') { var dtqcU = {}; }
 ...
 * @suppress {checkTypes}
 */
dtqcU.render = function(opt_data, opt_ignored, opt_ijData) {
...
if (goog.DEBUG) {
  dtqcU.render.soyTemplateName = 'dtqcU.render';
}
 ...
 * @suppress {checkTypes}
 */
dtqcU.soyweb = function(opt_data, opt_ignored, opt_ijData) {
  return soydata.VERY_UNSAFE.ordainSanitizedHtml(base.render(soy.$$augmentMap(opt_data, {content: soydata.VERY_UNSAFE.$$ordainSanitizedHtmlForInternalBlocks('' + dtqcU.render(opt_data, null, opt_ijData))}), null, opt_ijData));
};
if (goog.DEBUG) {
  dtqcU.soyweb.soyTemplateName = 'dtqcU.soyweb';
}
