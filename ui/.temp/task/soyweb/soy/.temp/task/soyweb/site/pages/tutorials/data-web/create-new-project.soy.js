...
/**
 * @fileoverview Templates in namespace XDsEn.
 */

if (typeof XDsEn == 'undefined') { var XDsEn = {}; }
 ...
 * @suppress {checkTypes}
 */
XDsEn.render = function(opt_data, opt_ignored, opt_ijData) {
...
if (goog.DEBUG) {
  XDsEn.render.soyTemplateName = 'XDsEn.render';
}
 ...
 * @suppress {checkTypes}
 */
XDsEn.soyweb = function(opt_data, opt_ignored, opt_ijData) {
  return soydata.VERY_UNSAFE.ordainSanitizedHtml(base.render(soy.$$augmentMap(opt_data, {content: soydata.VERY_UNSAFE.$$ordainSanitizedHtmlForInternalBlocks('' + XDsEn.render(opt_data, null, opt_ijData))}), null, opt_ijData));
};
if (goog.DEBUG) {
  XDsEn.soyweb.soyTemplateName = 'XDsEn.soyweb';
}
