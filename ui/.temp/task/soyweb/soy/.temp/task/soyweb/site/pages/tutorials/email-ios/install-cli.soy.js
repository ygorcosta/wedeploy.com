...
if (typeof ceZzZ == 'undefined') { var ceZzZ = {}; }
 ...
 * @suppress {checkTypes}
 */
ceZzZ.render = function(opt_data, opt_ignored, opt_ijData) {
...
if (goog.DEBUG) {
  ceZzZ.render.soyTemplateName = 'ceZzZ.render';
}
 ...
 * @suppress {checkTypes}
 */
ceZzZ.soyweb = function(opt_data, opt_ignored, opt_ijData) {
  return soydata.VERY_UNSAFE.ordainSanitizedHtml(base.render(soy.$$augmentMap(opt_data, {content: soydata.VERY_UNSAFE.$$ordainSanitizedHtmlForInternalBlocks('' + ceZzZ.render(opt_data, null, opt_ijData))}), null, opt_ijData));
};
if (goog.DEBUG) {
  ceZzZ.soyweb.soyTemplateName = 'ceZzZ.soyweb';
}
