...
/**
 * @fileoverview Templates in namespace lEqBO.
 */

if (typeof lEqBO == 'undefined') { var lEqBO = {}; }
 ...
 * @suppress {checkTypes}
 */
lEqBO.soyweb = function(opt_data, opt_ignored, opt_ijData) {
  return soydata.VERY_UNSAFE.ordainSanitizedHtml(base.render(soy.$$augmentMap(opt_data, {content: soydata.VERY_UNSAFE.$$ordainSanitizedHtmlForInternalBlocks('' + lEqBO.render(opt_data, null, opt_ijData))}), null, opt_ijData));
};
if (goog.DEBUG) {
  lEqBO.soyweb.soyTemplateName = 'lEqBO.soyweb';
}
