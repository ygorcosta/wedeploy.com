...
/**
 * @fileoverview Templates in namespace gugOf.
 */

if (typeof gugOf == 'undefined') { var gugOf = {}; }
 ...
 * @suppress {checkTypes}
 */
gugOf.render = function(opt_data, opt_ignored, opt_ijData) {
...
if (goog.DEBUG) {
  gugOf.render.soyTemplateName = 'gugOf.render';
}
 ...
 * @suppress {checkTypes}
 */
gugOf.soyweb = function(opt_data, opt_ignored, opt_ijData) {
  return soydata.VERY_UNSAFE.ordainSanitizedHtml(base.render(soy.$$augmentMap(opt_data, {content: soydata.VERY_UNSAFE.$$ordainSanitizedHtmlForInternalBlocks('' + gugOf.render(opt_data, null, opt_ijData))}), null, opt_ijData));
};
if (goog.DEBUG) {
  gugOf.soyweb.soyTemplateName = 'gugOf.soyweb';
}
