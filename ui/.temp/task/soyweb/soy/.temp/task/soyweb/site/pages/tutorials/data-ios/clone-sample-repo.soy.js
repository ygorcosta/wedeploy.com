...
/**
 * @fileoverview Templates in namespace AkVgi.
 */

if (typeof AkVgi == 'undefined') { var AkVgi = {}; }
 ...
 * @suppress {checkTypes}
 */
AkVgi.soyweb = function(opt_data, opt_ignored, opt_ijData) {
  return soydata.VERY_UNSAFE.ordainSanitizedHtml(base.render(soy.$$augmentMap(opt_data, {content: soydata.VERY_UNSAFE.$$ordainSanitizedHtmlForInternalBlocks('' + AkVgi.render(opt_data, null, opt_ijData))}), null, opt_ijData));
};
if (goog.DEBUG) {
  AkVgi.soyweb.soyTemplateName = 'AkVgi.soyweb';
}
