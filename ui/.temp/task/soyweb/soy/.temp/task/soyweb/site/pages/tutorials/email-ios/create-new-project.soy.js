...
/**
 * @fileoverview Templates in namespace bUqcK.
 */

if (typeof bUqcK == 'undefined') { var bUqcK = {}; }
 ...
 * @suppress {checkTypes}
 */
bUqcK.render = function(opt_data, opt_ignored, opt_ijData) {
...
if (goog.DEBUG) {
  bUqcK.render.soyTemplateName = 'bUqcK.render';
}
 ...
 * @suppress {checkTypes}
 */
bUqcK.soyweb = function(opt_data, opt_ignored, opt_ijData) {
  return soydata.VERY_UNSAFE.ordainSanitizedHtml(base.render(soy.$$augmentMap(opt_data, {content: soydata.VERY_UNSAFE.$$ordainSanitizedHtmlForInternalBlocks('' + bUqcK.render(opt_data, null, opt_ijData))}), null, opt_ijData));
};
if (goog.DEBUG) {
  bUqcK.soyweb.soyTemplateName = 'bUqcK.soyweb';
}
