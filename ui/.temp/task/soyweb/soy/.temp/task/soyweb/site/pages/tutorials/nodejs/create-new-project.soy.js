...
/**
 * @fileoverview Templates in namespace ImmXo.
 */

if (typeof ImmXo == 'undefined') { var ImmXo = {}; }
 ...
 * @suppress {checkTypes}
 */
ImmXo.render = function(opt_data, opt_ignored, opt_ijData) {
...
if (goog.DEBUG) {
  ImmXo.render.soyTemplateName = 'ImmXo.render';
}
 ...
 * @suppress {checkTypes}
 */
ImmXo.soyweb = function(opt_data, opt_ignored, opt_ijData) {
  return soydata.VERY_UNSAFE.ordainSanitizedHtml(base.render(soy.$$augmentMap(opt_data, {content: soydata.VERY_UNSAFE.$$ordainSanitizedHtmlForInternalBlocks('' + ImmXo.render(opt_data, null, opt_ijData))}), null, opt_ijData));
};
if (goog.DEBUG) {
  ImmXo.soyweb.soyTemplateName = 'ImmXo.soyweb';
}
