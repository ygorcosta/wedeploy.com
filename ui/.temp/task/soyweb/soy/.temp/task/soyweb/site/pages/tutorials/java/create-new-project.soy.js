...
/**
 * @fileoverview Templates in namespace lGVBF.
 */

if (typeof lGVBF == 'undefined') { var lGVBF = {}; }
 ...
 * @suppress {checkTypes}
 */
lGVBF.render = function(opt_data, opt_ignored, opt_ijData) {
...
if (goog.DEBUG) {
  lGVBF.render.soyTemplateName = 'lGVBF.render';
}
 ...
 * @suppress {checkTypes}
 */
lGVBF.soyweb = function(opt_data, opt_ignored, opt_ijData) {
  return soydata.VERY_UNSAFE.ordainSanitizedHtml(base.render(soy.$$augmentMap(opt_data, {content: soydata.VERY_UNSAFE.$$ordainSanitizedHtmlForInternalBlocks('' + lGVBF.render(opt_data, null, opt_ijData))}), null, opt_ijData));
};
if (goog.DEBUG) {
  lGVBF.soyweb.soyTemplateName = 'lGVBF.soyweb';
}
