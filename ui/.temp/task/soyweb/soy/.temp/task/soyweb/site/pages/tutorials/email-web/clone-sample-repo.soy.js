...
/**
 * @fileoverview Templates in namespace rVBNh.
 */

if (typeof rVBNh == 'undefined') { var rVBNh = {}; }
 ...
 * @suppress {checkTypes}
 */
rVBNh.soyweb = function(opt_data, opt_ignored, opt_ijData) {
  return soydata.VERY_UNSAFE.ordainSanitizedHtml(base.render(soy.$$augmentMap(opt_data, {content: soydata.VERY_UNSAFE.$$ordainSanitizedHtmlForInternalBlocks('' + rVBNh.render(opt_data, null, opt_ijData))}), null, opt_ijData));
};
if (goog.DEBUG) {
  rVBNh.soyweb.soyTemplateName = 'rVBNh.soyweb';
}
