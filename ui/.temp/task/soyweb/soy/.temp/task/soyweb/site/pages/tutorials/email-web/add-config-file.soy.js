...
if (typeof jbwLt == 'undefined') { var jbwLt = {}; }
 ...
 * @suppress {checkTypes}
 */
jbwLt.soyweb = function(opt_data, opt_ignored, opt_ijData) {
  return soydata.VERY_UNSAFE.ordainSanitizedHtml(base.render(soy.$$augmentMap(opt_data, {content: soydata.VERY_UNSAFE.$$ordainSanitizedHtmlForInternalBlocks('' + jbwLt.render(opt_data, null, opt_ijData))}), null, opt_ijData));
};
if (goog.DEBUG) {
  jbwLt.soyweb.soyTemplateName = 'jbwLt.soyweb';
}
