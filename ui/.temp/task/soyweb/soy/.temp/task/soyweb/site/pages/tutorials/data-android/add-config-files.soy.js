...
if (typeof dCnZI == 'undefined') { var dCnZI = {}; }
 ...
 * @suppress {checkTypes}
 */
dCnZI.soyweb = function(opt_data, opt_ignored, opt_ijData) {
  return soydata.VERY_UNSAFE.ordainSanitizedHtml(base.render(soy.$$augmentMap(opt_data, {content: soydata.VERY_UNSAFE.$$ordainSanitizedHtmlForInternalBlocks('' + dCnZI.render(opt_data, null, opt_ijData))}), null, opt_ijData));
};
if (goog.DEBUG) {
  dCnZI.soyweb.soyTemplateName = 'dCnZI.soyweb';
}
