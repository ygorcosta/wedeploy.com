...
/**
 * @fileoverview Templates in namespace aYIBh.
 */

if (typeof aYIBh == 'undefined') { var aYIBh = {}; }
 ...
 * @suppress {checkTypes}
 */
aYIBh.render = function(opt_data, opt_ignored, opt_ijData) {
...
if (goog.DEBUG) {
  aYIBh.render.soyTemplateName = 'aYIBh.render';
}
 ...
 * @suppress {checkTypes}
 */
aYIBh.soyweb = function(opt_data, opt_ignored, opt_ijData) {
  return soydata.VERY_UNSAFE.ordainSanitizedHtml(base.render(soy.$$augmentMap(opt_data, {content: soydata.VERY_UNSAFE.$$ordainSanitizedHtmlForInternalBlocks('' + aYIBh.render(opt_data, null, opt_ijData))}), null, opt_ijData));
};
if (goog.DEBUG) {
  aYIBh.soyweb.soyTemplateName = 'aYIBh.soyweb';
}
