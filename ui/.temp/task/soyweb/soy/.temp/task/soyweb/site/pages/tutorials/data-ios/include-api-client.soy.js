...
if (typeof XtyUG == 'undefined') { var XtyUG = {}; }
 ...
 * @suppress {checkTypes}
 */
XtyUG.render = function(opt_data, opt_ignored, opt_ijData) {
...
if (goog.DEBUG) {
  XtyUG.render.soyTemplateName = 'XtyUG.render';
}
 ...
 * @suppress {checkTypes}
 */
XtyUG.soyweb = function(opt_data, opt_ignored, opt_ijData) {
  return soydata.VERY_UNSAFE.ordainSanitizedHtml(base.render(soy.$$augmentMap(opt_data, {content: soydata.VERY_UNSAFE.$$ordainSanitizedHtmlForInternalBlocks('' + XtyUG.render(opt_data, null, opt_ijData))}), null, opt_ijData));
};
if (goog.DEBUG) {
  XtyUG.soyweb.soyTemplateName = 'XtyUG.soyweb';
}
