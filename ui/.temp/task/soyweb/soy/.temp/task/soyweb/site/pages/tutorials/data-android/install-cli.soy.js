...
/**
 * @fileoverview Templates in namespace WLDyN.
 */

if (typeof WLDyN == 'undefined') { var WLDyN = {}; }
 ...
 * @suppress {checkTypes}
 */
WLDyN.render = function(opt_data, opt_ignored, opt_ijData) {
...
if (goog.DEBUG) {
  WLDyN.render.soyTemplateName = 'WLDyN.render';
}
 ...
 * @suppress {checkTypes}
 */
WLDyN.soyweb = function(opt_data, opt_ignored, opt_ijData) {
  return soydata.VERY_UNSAFE.ordainSanitizedHtml(base.render(soy.$$augmentMap(opt_data, {content: soydata.VERY_UNSAFE.$$ordainSanitizedHtmlForInternalBlocks('' + WLDyN.render(opt_data, null, opt_ijData))}), null, opt_ijData));
};
if (goog.DEBUG) {
  WLDyN.soyweb.soyTemplateName = 'WLDyN.soyweb';
}
