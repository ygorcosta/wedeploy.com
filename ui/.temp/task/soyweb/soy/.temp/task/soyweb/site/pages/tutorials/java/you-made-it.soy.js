...
/**
 * @fileoverview Templates in namespace NLxAr.
 */

if (typeof NLxAr == 'undefined') { var NLxAr = {}; }
 ...
 * @suppress {checkTypes}
 */
NLxAr.soyweb = function(opt_data, opt_ignored, opt_ijData) {
  return soydata.VERY_UNSAFE.ordainSanitizedHtml(base.render(soy.$$augmentMap(opt_data, {content: soydata.VERY_UNSAFE.$$ordainSanitizedHtmlForInternalBlocks('' + NLxAr.render(opt_data, null, opt_ijData))}), null, opt_ijData));
};
if (goog.DEBUG) {
  NLxAr.soyweb.soyTemplateName = 'NLxAr.soyweb';
}
