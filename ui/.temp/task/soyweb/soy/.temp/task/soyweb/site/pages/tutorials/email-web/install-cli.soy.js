...
if (typeof JJpjA == 'undefined') { var JJpjA = {}; }
 ...
 * @suppress {checkTypes}
 */
JJpjA.render = function(opt_data, opt_ignored, opt_ijData) {
...
if (goog.DEBUG) {
  JJpjA.render.soyTemplateName = 'JJpjA.render';
}
 ...
 * @suppress {checkTypes}
 */
JJpjA.soyweb = function(opt_data, opt_ignored, opt_ijData) {
  return soydata.VERY_UNSAFE.ordainSanitizedHtml(base.render(soy.$$augmentMap(opt_data, {content: soydata.VERY_UNSAFE.$$ordainSanitizedHtmlForInternalBlocks('' + JJpjA.render(opt_data, null, opt_ijData))}), null, opt_ijData));
};
if (goog.DEBUG) {
  JJpjA.soyweb.soyTemplateName = 'JJpjA.soyweb';
}
