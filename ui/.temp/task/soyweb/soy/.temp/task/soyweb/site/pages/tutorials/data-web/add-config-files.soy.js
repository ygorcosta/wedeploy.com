...
/**
 * @fileoverview Templates in namespace bpGiU.
 */

if (typeof bpGiU == 'undefined') { var bpGiU = {}; }
 ...
 * @suppress {checkTypes}
 */
bpGiU.soyweb = function(opt_data, opt_ignored, opt_ijData) {
  return soydata.VERY_UNSAFE.ordainSanitizedHtml(base.render(soy.$$augmentMap(opt_data, {content: soydata.VERY_UNSAFE.$$ordainSanitizedHtmlForInternalBlocks('' + bpGiU.render(opt_data, null, opt_ijData))}), null, opt_ijData));
};
if (goog.DEBUG) {
  bpGiU.soyweb.soyTemplateName = 'bpGiU.soyweb';
}
