...
/**
 * @fileoverview Templates in namespace XgsEp.
 */

if (typeof XgsEp == 'undefined') { var XgsEp = {}; }
 ...
 * @suppress {checkTypes}
 */
XgsEp.soyweb = function(opt_data, opt_ignored, opt_ijData) {
  return soydata.VERY_UNSAFE.ordainSanitizedHtml(base.render(soy.$$augmentMap(opt_data, {content: soydata.VERY_UNSAFE.$$ordainSanitizedHtmlForInternalBlocks('' + XgsEp.render(opt_data, null, opt_ijData))}), null, opt_ijData));
};
if (goog.DEBUG) {
  XgsEp.soyweb.soyTemplateName = 'XgsEp.soyweb';
}
