...
/**
 * @fileoverview Templates in namespace MtvMP.
 */

if (typeof MtvMP == 'undefined') { var MtvMP = {}; }
 ...
 * @suppress {checkTypes}
 */
MtvMP.render = function(opt_data, opt_ignored, opt_ijData) {
...
if (goog.DEBUG) {
  MtvMP.render.soyTemplateName = 'MtvMP.render';
}
 ...
 * @suppress {checkTypes}
 */
MtvMP.soyweb = function(opt_data, opt_ignored, opt_ijData) {
  return soydata.VERY_UNSAFE.ordainSanitizedHtml(base.render(soy.$$augmentMap(opt_data, {content: soydata.VERY_UNSAFE.$$ordainSanitizedHtmlForInternalBlocks('' + MtvMP.render(opt_data, null, opt_ijData))}), null, opt_ijData));
};
if (goog.DEBUG) {
  MtvMP.soyweb.soyTemplateName = 'MtvMP.soyweb';
}
