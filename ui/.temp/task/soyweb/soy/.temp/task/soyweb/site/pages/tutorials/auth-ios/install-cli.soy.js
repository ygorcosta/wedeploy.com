...
/**
 * @fileoverview Templates in namespace ZWhPF.
 */

if (typeof ZWhPF == 'undefined') { var ZWhPF = {}; }
 ...
 * @suppress {checkTypes}
 */
ZWhPF.render = function(opt_data, opt_ignored, opt_ijData) {
...
if (goog.DEBUG) {
  ZWhPF.render.soyTemplateName = 'ZWhPF.render';
}
 ...
 * @suppress {checkTypes}
 */
ZWhPF.soyweb = function(opt_data, opt_ignored, opt_ijData) {
  return soydata.VERY_UNSAFE.ordainSanitizedHtml(base.render(soy.$$augmentMap(opt_data, {content: soydata.VERY_UNSAFE.$$ordainSanitizedHtmlForInternalBlocks('' + ZWhPF.render(opt_data, null, opt_ijData))}), null, opt_ijData));
};
if (goog.DEBUG) {
  ZWhPF.soyweb.soyTemplateName = 'ZWhPF.soyweb';
}
