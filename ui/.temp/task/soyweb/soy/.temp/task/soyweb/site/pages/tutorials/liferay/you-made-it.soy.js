...
if (typeof IrbgJ == 'undefined') { var IrbgJ = {}; }
 ...
 * @suppress {checkTypes}
 */
IrbgJ.soyweb = function(opt_data, opt_ignored, opt_ijData) {
  return soydata.VERY_UNSAFE.ordainSanitizedHtml(base.render(soy.$$augmentMap(opt_data, {content: soydata.VERY_UNSAFE.$$ordainSanitizedHtmlForInternalBlocks('' + IrbgJ.render(opt_data, null, opt_ijData))}), null, opt_ijData));
};
if (goog.DEBUG) {
  IrbgJ.soyweb.soyTemplateName = 'IrbgJ.soyweb';
}
