...
/**
 * @fileoverview Templates in namespace rPbcC.
 */

if (typeof rPbcC == 'undefined') { var rPbcC = {}; }
 ...
 * @suppress {checkTypes}
 */
rPbcC.render = function(opt_data, opt_ignored, opt_ijData) {
...
if (goog.DEBUG) {
  rPbcC.render.soyTemplateName = 'rPbcC.render';
}
 ...
 * @suppress {checkTypes}
 */
rPbcC.soyweb = function(opt_data, opt_ignored, opt_ijData) {
  return soydata.VERY_UNSAFE.ordainSanitizedHtml(base.render(soy.$$augmentMap(opt_data, {content: soydata.VERY_UNSAFE.$$ordainSanitizedHtmlForInternalBlocks('' + rPbcC.render(opt_data, null, opt_ijData))}), null, opt_ijData));
};
if (goog.DEBUG) {
  rPbcC.soyweb.soyTemplateName = 'rPbcC.soyweb';
}
