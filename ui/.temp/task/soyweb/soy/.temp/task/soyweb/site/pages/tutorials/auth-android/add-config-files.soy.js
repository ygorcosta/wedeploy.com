...
/**
 * @fileoverview Templates in namespace LHOsG.
 */

if (typeof LHOsG == 'undefined') { var LHOsG = {}; }
 ...
 * @suppress {checkTypes}
 */
LHOsG.soyweb = function(opt_data, opt_ignored, opt_ijData) {
  return soydata.VERY_UNSAFE.ordainSanitizedHtml(base.render(soy.$$augmentMap(opt_data, {content: soydata.VERY_UNSAFE.$$ordainSanitizedHtmlForInternalBlocks('' + LHOsG.render(opt_data, null, opt_ijData))}), null, opt_ijData));
};
if (goog.DEBUG) {
  LHOsG.soyweb.soyTemplateName = 'LHOsG.soyweb';
}
