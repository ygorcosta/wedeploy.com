...
/**
 * @fileoverview Templates in namespace ywjtP.
 */

if (typeof ywjtP == 'undefined') { var ywjtP = {}; }
 ...
 * @suppress {checkTypes}
 */
ywjtP.render = function(opt_data, opt_ignored, opt_ijData) {
...
if (goog.DEBUG) {
  ywjtP.render.soyTemplateName = 'ywjtP.render';
}
 ...
 * @suppress {checkTypes}
 */
ywjtP.soyweb = function(opt_data, opt_ignored, opt_ijData) {
  return soydata.VERY_UNSAFE.ordainSanitizedHtml(base.render(soy.$$augmentMap(opt_data, {content: soydata.VERY_UNSAFE.$$ordainSanitizedHtmlForInternalBlocks('' + ywjtP.render(opt_data, null, opt_ijData))}), null, opt_ijData));
};
if (goog.DEBUG) {
  ywjtP.soyweb.soyTemplateName = 'ywjtP.soyweb';
}
