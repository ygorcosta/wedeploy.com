...
/**
 * @fileoverview Templates in namespace bozJp.
 */

if (typeof bozJp == 'undefined') { var bozJp = {}; }
 ...
 * @suppress {checkTypes}
 */
bozJp.soyweb = function(opt_data, opt_ignored, opt_ijData) {
  return soydata.VERY_UNSAFE.ordainSanitizedHtml(base.render(soy.$$augmentMap(opt_data, {content: soydata.VERY_UNSAFE.$$ordainSanitizedHtmlForInternalBlocks('' + bozJp.render(opt_data, null, opt_ijData))}), null, opt_ijData));
};
if (goog.DEBUG) {
  bozJp.soyweb.soyTemplateName = 'bozJp.soyweb';
}
