...
All the projects you created on alpha still exist, however on September 7th they will be **unavailable**, along with the previous Dashboard. But don't worry, we already have a **[Migration Guide](/docs/deploy/migrating-to-beta/)** ready so you can get started right away.
